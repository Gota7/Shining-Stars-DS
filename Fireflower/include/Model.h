...
extern "C"
{
	...
	//These are the file pointers of the models and texseqs above
	extern SharedFilePtr LUIGI_CAP_FILE_PTR;
	extern SharedFilePtr NUMBER_FILE_PTR;
	extern SharedFilePtr POWER_FLOWER_OPEN_FILE_PTR;
	extern SharedFilePtr COIN_YELLOW_POLY32_FILE_PTR;
	extern SharedFilePtr WARIO_CAP_FILE_PTR;
	extern SharedFilePtr COIN_BLUE_POLY32_FILE_PTR;
	extern SharedFilePtr POWER_FLOWER_CLOSED_FILE_PTR;
	extern SharedFilePtr ONE_UP_MUSHROOM_FILE_PTR;
	extern SharedFilePtr BOB_OMB_FILE_PTR;
	extern SharedFilePtr NUMBER_FILE_PTR;
	extern SharedFilePtr SNUFIT_BULLET_FILE_PTR;
	extern SharedFilePtr COIN_RED_POLY32_FILE_PTR;
	extern SharedFilePtr COIN_BLUE_POLY4_FILE_PTR;
	extern SharedFilePtr SILVER_NUMBER_FILE_PTR;
	extern SharedFilePtr WATER_RING_FILE_PTR;
	extern SharedFilePtr SHELL_GREEN_FILE_PTR;
	extern SharedFilePtr SHELL_RED_FILE_PTR;
	extern SharedFilePtr SILVER_NUMBER_FILE_PTR;
	extern SharedFilePtr SUPER_MUSHROOM_FILE_PTR;
	extern SharedFilePtr BUBBLE_FILE_PTR;
	extern SharedFilePtr MARIO_CAP_FILE_PTR;
	extern SharedFilePtr COIN_YELLOW_POLY4_FILE_PTR;
	extern SharedFilePtr COIN_RED_POLY4_FILE_PTR;
	extern SharedFilePtr FEATHER_FILE_PTR;
...
struct Animation	//internal: FrameCtrl; done
{
	...
	void SetAnimation(uint16_t frames, int flags, Fix12i speed, uint16_t startFrame);
...
struct MaterialChanger : Animation		//internal: AnmMaterial; done
{
	...
	void SetMaterial(MaterialDef& matDef, int flags, Fix12i speed, unsigned startFrame);
